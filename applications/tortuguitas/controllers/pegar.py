...
from applications.tortuguitas.controllers.analise import master
from os import path as patrick

def json_br():
	if (patrick.exists("applications/tortuguitas/controllers/casos_atualizados_brasil.json")) == False:
		master()

	f = open('applications/tortuguitas/controllers/casos_atualizados_brasil.json',)
...
def json_za_warudo():
	...
	f = open('applications/tortuguitas/controllers/casos_atualizados_mundo.json',)
