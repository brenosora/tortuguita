...
# Se bem sucedido realiza a coleta de dados
    ...
    # r = requests.get('https://covid-api-brasil.herokuapp.com/casos')
        ...
        with open('applications/tortuguitas/controllers/casos_atualizados_brasil.json', 'w') as f1:
    ...
    # r = requests.get('https://covid-api-brasil.herokuapp.com/casos')
        ...
        with open('applications/tortuguitas/controllers/casos_atualizados_mundo.json', 'w') as f3:
